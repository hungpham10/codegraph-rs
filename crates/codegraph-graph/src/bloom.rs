...
//!
//! ## Dùng trong SearchIndex
//!
//! Mỗi node radix-tree có một bloom filter encoding toàn bộ bigram trong subtree.
//! Khi search, trích bigram từ pattern, kiểm tra bloom của candidate node.
//! Nếu bloom nói "không" → skip cả subtree, không cần DFS.
//! Nếu bloom nói "có" → vẫn DFS bình thường (false positive không gây sai kết quả).
